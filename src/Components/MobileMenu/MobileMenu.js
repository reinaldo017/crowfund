...
const MobileMenu = ({ links, toggleMobileMenu }) => {
  const linksArr = links.map(linkName => {
    return (
      <li key={linkName} className='mobile-menu__li'>
        <a className='mobile-menu__a'>{linkName}</a>
      </li>
    )
  })
